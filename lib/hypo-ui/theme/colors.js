...
const names = ['red', 'pink', 'purple', 'deepPurple', 'indigo', 'blue', 'lightBlue', 'cyan', 'teal', 'green', 'lightGreen', 'lime', 'yellow', 'amber', 'orange', 'deepOrange', 'brown', 'grey', 'blueGrey'];
const grades = ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900', 'A100', 'A200', 'A400', 'A700'];
...
for (let n = 0; n < names.length; n++) {
    ...
    for (let i = 0; i < grades.length; i++) {
        ...
        colors[name][grade] = colorMap[i][colorIndex];
    }
    colorIndex++;
}
...
colors = {
    ...
    primaryLight: colors.lightBlue[100],
    primary: colors.lightBlue[300],
    primaryDark: colors.lightBlue[400],
    primaryGrey: colors.grey[800],

    secondaryLight: colors.teal[100],
    secondary: colors.teal[300],
    secondaryDark: colors.teal[400],

    dangerLight: colors.red[500],
    danger: colors.red[700],
    dangerDark: colors.red[900],
